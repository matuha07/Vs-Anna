...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Set Cam Speed', "Sets camera bopping speed,\nValue 1: 1 = Every beat,\n2 = 1/2 speed, 4 = 1/4 Every Section etc.\nUsed on Fresh during the beatbox parts.\n\nWarning: Value must be integer!"],
		['Set Cam Zoom Intensity', "Sets camera bop intensity"],
		['Set Cam Pan Intensity', "Sets camera pan Speed"]
	];
